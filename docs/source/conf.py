...
modindex_common_prefix = ["semantic_pydantic."]
...
htmlhelp_basename = "semantic_pydantic_doc"
...
#     (
#         master_doc,
#         'semantic_pydantic.tex',
#         'Semantic Pydantic Documentation',
#         author,
#         'manual',
#     ),
# ]
...
# Note: don't add trailing commas, since sphinx adds "/objects.inv" to the end
intersphinx_mapping = {
